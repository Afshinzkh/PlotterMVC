...
namespace AwokeKnowing.GnuplotCSharp
{
    class GnuPlot
    {
        ...
        public static void setStringValue(string valueName, string value)
        {
            GnupStWr.WriteLine(valueName + "= '" + value + "'");
        }
        ...
        {
            for (int i = 0; i < y.Length; i++)
                stream.WriteLine(x[i].ToString(System.Globalization.CultureInfo.InvariantCulture) + " " + y[i].ToString(System.Globalization.CultureInfo.InvariantCulture));
